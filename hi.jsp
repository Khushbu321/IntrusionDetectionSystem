...
<div id="templatemo_wrapper">
	...
	<div style="position:absolute; left:373px; top:303px; width: 254px; height: 173px;">
	<table width="100">
  <tr><td width="75"></td>
  <td bgcolor="#DE325E"><font color="#FFCCCC" size="2">IP address</font></td>
  <td bgcolor="#DE325E"><font color="#FFCCCC" size="2">Date & Time</font></td>
  <td bgcolor="#DE325E"><font color="#FFCCCC" size="2">OS</font></td>
  <td bgcolor="#DE325E"><font color="#FFCCCC" size="2">Version</font></td>
    <td bgcolor="#DE325E"><font color="#FFCCCC" size="2">Desktop</font></td>
...
PreparedStatement stmt1 = con1.prepareStatement("select ipadd,time,os,version,desktop from ipadd where id='"+zz+"'");
...
<td bgcolor="#FF9933" width="15"><font size="2"><%=f1%></font></td>
</tr>
<%
}
}
...
<div style="position:absolute; left:780px; top:247px; width: 248px; height: 318px;">
