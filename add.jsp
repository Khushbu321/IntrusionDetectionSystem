...
<%@ page import="java.io.*"%>
<%@ page contentType="text/html; charset=utf-8" language="java" import="java.sql.*" errorPage="" import = "java.util.Date,java.text.SimpleDateFormat,java.text.ParseException" %><html>
...
<div style="position:absolute; left:333px; top:355px; width: 366px; height: 231px;">
<a href="add.jsp"><font color="#33CC33" face="Times New Roman, Times, serif" size="+2">Add Photos</font></a>
</a>
...
%>
  ...
  <br>
  <img src="use3.jsp" width="163" height="179"> 
  <br>
...
&nbsp;&nbsp;<a href="1.jsp"><font color="#FF3300" face="Times New Roman, Times, serif"><strong>
 ...
 <div style="position:absolute; left:796px; top:198px; width: 235px; height: 318px;">
