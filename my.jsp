...
<div id="templatemo_wrapper"> 
    ...
    <div id="templatemo_main"><!-- 1---------------------------------------------------------------------------------------------------->
	  ...
	  <div class="col_allw280">
                <h3>
<div style="position:absolute; left:349px; top:235px; width: 355px; height: 320px;">
  <p><a href="#"><font color="#33CC33" face="Times New Roman, Times, serif" size="+2"></font></a> </p>
...
PreparedStatement stmt5 = con5.prepareStatement("select name,email,password,mobile,gender,birthday,uid from userdetails where email='"+a+"' AND social='"+w+"'");
...
<tr><td><font face="Georgia, Times New Roman, Times, serif" color="#ffffff" size="2"><b>Name: </b></font></td><td><font face="Georgia, Times New Roman, Times, serif" color="#ffffff" size="2"><%=m%></font></td></tr><br>
<tr><td><font face="Georgia, Times New Roman, Times, serif" color="#ffffff" size="2"><b>Email Id: </b></font></td><td><font face="Georgia, Times New Roman, Times, serif" color="#ffffff" size="2"><%=n%></font></td></tr><br>

<tr><td><font face="Georgia, Times New Roman, Times, serif" color="#ffffff" size="2"><b>Mobile:</b></font></td><td><font face="Georgia, Times New Roman, Times, serif" color="#ffffff" size="2"><%=p%></font></td></tr><br>
<tr><td><font face="Georgia, Times New Roman, Times, serif" color="#ffffff" size="2"><b>Gender: </b></font></td><td><font face="Georgia, Times New Roman, Times, serif" color="#ffffff" size="2"><%=q%></font></td></tr><br>
<tr><td><font face="Georgia, Times New Roman, Times, serif" color="#ffffff" size="2"><b>Birthday: </b></font></td><td><font face="Georgia, Times New Roman, Times, serif" color="#ffffff" size="2"><%=r%></font></td></tr><br>
<tr><td><font face="Georgia, Times New Roman, Times, serif" color="#ffffff" size="2"><b>Profile Photo: </b></font></td><td><img src="f1.jsp?<%=s%>" height="155" width="155"></td></tr>
...
&nbsp;&nbsp;<a href="1.jsp"><font color="#FF3300" face="Times New Roman, Times, serif"><strong>
 ...
 <div style="position:absolute; left:794px; top:271px; width: 248px; height: 318px;">
