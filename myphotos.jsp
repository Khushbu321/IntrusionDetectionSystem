...
<div style="position:absolute; left:401px; top:363px; width: 390px; height: 246px;">
  <p><a href="#"><font color="#33CC33" face="Times New Roman, Times, serif" size="+2">My Photos</font></a> </p>
  <p><br>
  </p>
 <table width="500"> 
<%
...
PreparedStatement stmt1 = con1.prepareStatement("select id,msg from photos where id1='"+m+"' AND social='"+w+"'");
...
while(rs1.next()) {
 q=rs1.getString(1);
    v=rs1.getString(2);
%>
 <tr><td><img src="f3.jsp?<%=q%>" height="105" width="105"></td><td><%=v%></tr>
...
&nbsp;&nbsp;<a href="1.jsp"><font color="#FF3300" face="Times New Roman, Times, serif"><strong>
 ...
 <div style="position:absolute; left:742px; top:290px; width: 248px; height: 318px;">
