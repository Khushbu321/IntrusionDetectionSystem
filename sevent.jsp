...
function validation()
{
if(document.s1.type.selectedIndex==0)
{
...
<div id="templatemo_wrapper">
	...
	<div style="position:absolute; left:351px; top:334px; width: 351px; height: 503px;">
  <p><a href="sevent.jsp"><font color="#33CC33" face="Times New Roman, Times, serif" size="+2">Search Event</font></a>
	
	
  
  <form name="s1" action="sevents.jsp" onSubmit="return validation()">
 <table bgcolor="#DE325E">
 <tr>
                  <td><b><font face="Georgia, Times New Roman, Times, serif" color="#FFFFFF" size="3">Search Basesd</font></b></td>
                  <td><select name="type">
 <option value="0">select type</option>
 <option value="date">Date</option>
  <option value="place">place</option>
 </select></td></tr>
<tr><td><b><font color="#FFFFFF" face="Georgia, Times New Roman, Times, serif" size="3">Enter Date or Place or Details</font></b></td><td><input type="text" name="t" placeholder="date will be 'yyyy-mm-dd' or place or details" size="30"></td></tr>
<tr><td></td><td><input type="submit" value="submit"><input type="reset" value="clear"></td></tr></table></form>
	<table> 
<%
...
<div style="position:absolute; left:774px; top:255px; width: 248px; height: 318px;">
