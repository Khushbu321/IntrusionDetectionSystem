...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
	  ...
	  <div class="col_allw280">
                <h3>
<div style="position:absolute; left:381px; top:269px;">
<table width="250" height="200" bgcolor="#DE325E">
<%
...
PreparedStatement stmt = con.prepareStatement("select name,email,mobile,gender,uid from userdetails where uid='"+b+"'");
...
%>
<tr>
<td><h1><font color="#FFFFFF" face="Georgia, Times New Roman, Times, serif" size="2">Profile photo:</font></h1></td><td><img src="f1.jsp?<%=name4%>" height="100" width="100"></td>
</tr>
<tr>
<tr>
<td><h1><font color="#FFFFFF" face="Georgia, Times New Roman, Times, serif" size="2">Name:</font></h1></td>
<td><h2><font color="#FFFFFF" face="Georgia, Times New Roman, Times, serif" size="2"><%=name%></font>
</h2></td></tr>
<tr>
<td><h1><font color="#FFFFFF" face="Georgia, Times New Roman, Times, serif" size="2">Email id :</font></h1></td>
<td><h2><font color="#FFFFFF" face="Georgia, Times New Roman, Times, serif" size="2"><%=name1%></font>
</h2></td></tr>
<tr>
<td><h1><font color="#FFFFFF" face="Georgia, Times New Roman, Times, serif" size="2">Mobile :</font></h1></td>
<td><h2><font color="#FFFFFF" face="Georgia, Times New Roman, Times, serif" size="2"><%=name2%></font>
</h2></td></tr>

<tr><td><h1><font color="#FFFFFF" face="Georgia, Times New Roman, Times, serif" size="2">Gender :</font></h1></td>
<td><h2><font color="#FFFFFF" face="Georgia, Times New Roman, Times, serif" size="2"><%=name3%></font>
</h2></td></tr>
<tr><td></td>
                <td><h2> <a href="fr4.jsp?<%=name4%>"><font color="#666666"><b><font color="#FFFFFF" face="Georgia, Times New Roman, Times, serif" size="2">Accept 
...
&nbsp;&nbsp;<a href="1.jsp"><font color="#FF3300" face="Times New Roman, Times, serif"><strong>
 ...
 <div style="position:absolute; left:793px; top:197px; width: 248px; height: 318px;">
...
Connection con11 = DriverManager.getConnection("jdbc:mysql://localhost:3306/social","root","admin");
